...
const LoginScreen = (props: any) => {
  ...
  GoogleSignin.configure({
    webClientId: '879735432336-2iku0t17dcn2utnku8ijgtdrool8gnq7.apps.googleusercontent.com',
    ...
    <KeyboardAwareScrollView>
      ...
      <View style={{ paddingHorizontal: PADDING_HORIZONTAL, paddingTop: PADDING_TOP, width: WIDTH, backgroundColor: BG_COLOR, height: HEIGHT }}>
        ...
        <View style={styles.header}>
          <Image style={{ width: 110, height: 110, marginRight: 20}} source={require('../../asset/image/logolata.png')} />
          <Text style={styles.textHeader}>Handbag Shop</Text>
        </View>
        <View>
          <Text style={styles.textWelcome}>CHÀO MỪNG ĐẾN VỚI LATA</Text>
        </View>
