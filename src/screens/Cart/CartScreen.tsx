            ...
            <View style={styles.itemCart}>
                ...
                <View style={{ flexDirection: 'column', height: '100%' }}>
                    ...
                    <View style={styles.bottomItem}>
                        ...
                        <View style={{ flexDirection: 'row', backgroundColor: 'white', borderRadius: 5, alignItems: 'center', justifyContent: 'space-between', width: 100, height: 30, paddingHorizontal: 2, position: 'absolute', right: 5}}>
